...
// Creator details
global.ownernumber = process.env.OWNER_NUMBER || '2349137802868';
global.ownername = process.env.OWNER_NAME || 'TECHMASTER';
global.botname = process.env.BOT_NAME || 'BYTESTORM';
...
global.author = process.env.AUTHOR || 'TECHMASTER\n\nContact: +2349137802868';
// Default settings 2
global.typemenu = process.env.TYPE_MENU || 'v2';
global.wm = process.env.WM || "Youtube @Hao-Tec";
global.link = process.env.LINK || 'https://whatsapp.com';
